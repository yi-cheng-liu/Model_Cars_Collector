"""
Django settings for model_car_collector project.
...
ALLOWED_HOSTS = ['localhost', '0.0.0.0', '54.227.246.216']
...
ROOT_URLCONF = "model_car_collector.urls"
...
WSGI_APPLICATION = "model_car_collector.wsgi.application"
